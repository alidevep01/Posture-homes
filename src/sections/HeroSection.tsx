      ...
      <div className="mx-auto grid max-w-6xl gap-14 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-24">
        ...
        >
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <a
              href="#products"
              className="inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-medium text-slate-900 transition hover:border-slate-900"
            >
              Explore Products
            </a>
          </div>
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-5 shadow-[0_24px_60px_-30px_rgba(15,23,42,0.35)]">
            <div className="aspect-[4/5] rounded-[1.5rem] bg-[linear-gradient(160deg,#d6c7b2_0%,#f7f2ea_45%,#efe7da_100%)] p-6">
